...
INSTALL_JS_GLOBAL="/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
