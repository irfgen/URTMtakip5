...
```bash
INIT=$(node "/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/templates/spec.md.
