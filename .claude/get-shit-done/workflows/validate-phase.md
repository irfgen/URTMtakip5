...
```
Task(
  prompt="Read /home/irfan/Belgeler/URTMtakip5/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/templates/VALIDATION.md`
