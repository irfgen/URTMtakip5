...
- **Global scope**: `/home/irfan/Belgeler/URTMtakip5/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/irfan/Belgeler/URTMtakip5/.claude/notes/`)
...
2. Glob `/home/irfan/Belgeler/URTMtakip5/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/irfan/Belgeler/URTMtakip5/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/irfan/Belgeler/URTMtakip5/.claude/notes/` — works in any directory
