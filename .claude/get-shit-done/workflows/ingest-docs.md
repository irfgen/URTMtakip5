...
```bash
INIT=$(node "/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/irfan/Belgeler/URTMtakip5/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
