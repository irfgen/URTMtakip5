...
VERSION_MINOR = 2
VERSION_PATCH = 20
VERSION_BUILD = 20250107005  # YYYYMMDDXXX format
...
RELEASE_NOTES = [
    "v1.2.20 - 2025-10-07:",
    "- KRITIK: Montaj dosya yolu kaydetme sorununu gidermek için detaylı INFO logları eklendi",
    "- GELİŞTİRME: Backend ve Client'ta sldasm_yolu transferi izlenebilir hale getirildi",
    "",
    "v1.2.19 - 2025-10-07:",
    "- KRITIK: Parça-detay penceresinde montaj dosyaları görüntülenme sorunu düzeltildi",
    "- KRITIK: combine_part_data fonksiyonunda yanlış anahtar isimleri düzeltildi (_files suffix)",
    ...
    "- GELİŞTİRME: select_assemblies fonksiyonuna detaylı debug logging eklendi",
    "",
    "v1.2.18 - 2025-10-07:",
    "- YENİ: Tarama sonuçlarında Montaj (.sldasm) sütunu eklendi",
    "- KRITIK: Montaj dosyalarının görüntülenmemesi sorunu düzeltildi",
    "",
    "v1.2.17 - 2025-10-07:",
    "- YENİ: .sldasm montaj dosyaları (.sldasm) desteği eklendi",
    "- YENİ: Montajları Seç (🔧) filtre butonu eklendi",
    "- YENİ: Backend'de sldasm_yolu alanı eklendi",
    "- KRITIK: PDF dosyası (teknik_resim_path) kaydetme sorunu düzeltildi",
    "- GELİŞTİRME: Parça detay penceresinde montaj dosyaları gösterimi",
    "- GELİŞTİRME: Dosya yolu kaydetme sistemi iyileştirildi",
    "",
    "v1.2.16 - 2025-10-07:",
