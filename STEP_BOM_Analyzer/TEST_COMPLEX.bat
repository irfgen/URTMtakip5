...
if not "!FREECAD_PATH!"=="" (
    ...
    REM Direct path assignment based on common locations
    ...
    ) else if exist "C:\Program Files\FreeCAD 0.20\bin\python.exe" (
        set "FREECAD_PYTHON=C:\Program Files\FreeCAD 0.20\bin\python.exe"
    ) else if exist "C:\Program Files (x86)\FreeCAD 1.0\bin\python.exe" (
